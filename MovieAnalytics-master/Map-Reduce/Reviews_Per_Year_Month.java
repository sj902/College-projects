...
public class Reviews_Per_Day {
    ...
    public static class E_EMapper extends MapReduceBase implements
        ...
        public void map(LongWritable key, Text value,
            ...
            if (s[0].equals("product/productId:")) {
                ...
                String Date = new java.text.SimpleDateFormat("yyyy/MM").format(new java.util.Date(Long.parseLong(s[1]) * 1000));
    ...
    public static void main(String args[]) throws Exception {
        JobConf conf = new JobConf(Reviews_Per_Day.class);

        conf.setJobName("Reviews_Per_Day");
